...
public class JWTTokenValidatorFilter /* extends OncePerRequestFilter */ {
	 ...
	 * ServletException { String jwt =
	 * request.getHeader(SecurityConstants.JWT_HEADER); if (null != jwt) { try {
	 * SecretKey key =
	 ...
	 * ; String username = String.valueOf(claims.get("username")); String
	 * authorities = (String) claims.get("authorities"); Authentication auth = new
	 ...
	 * (Exception e) { throw new BadCredentialsException("Invalid Token received!");
	 * } } chain.doFilter(request, response); }
	 * 
	 * @Override protected boolean shouldNotFilter(HttpServletRequest request) {
	 * return request.getServletPath().equals("/login"); } // không nên áp dụng cho
	 * login request
	 */
}
